...
const Header = () => {
  ...
  return (
    ...
    viewport={{once:true}} >
        ...
        <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[599px] mx-auto mt-10 text-center'>Turn text to <span className='text-blue-600'
        initial={{opacity: 0}}
        animate={{opacity: 1}}
        ...
        >Generate Images <img className='h-6' src={assets.star_group} /></motion.button>
        ...
        className='mt-2 text-neutral-600'>
          Generated images from Skriptodoodle
        </motion.p>
    </motion.div>
  )
}
